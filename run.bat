...
start cmd /k "cd /d %CURRENT_DIR%\scripts && call run_client.bat"
...
start cmd /k "cd /d %CURRENT_DIR%\server\venv\Scripts && call activate && cd /d %CURRENT_DIR%\server\scripts && call run_server.bat"
